...
export function extractPriceSignals(listing, weightMap) {
    ...
    if (veryLowRoom || lowUnit) {
        ...
        out.push({
            ...
            why_it_matters: "Scam listings often use unusually low rent to create urgency and extract a deposit before a viewing.",
    ...
    if (z > 2.4) {
        ...
        out.push({
            ...
            why_it_matters: "Unusually high rent can indicate predatory terms, hidden fees, or misleading listing details.",
            evidence: baselineExplain,
            value,
            weight,
            contribution: weight * value,
